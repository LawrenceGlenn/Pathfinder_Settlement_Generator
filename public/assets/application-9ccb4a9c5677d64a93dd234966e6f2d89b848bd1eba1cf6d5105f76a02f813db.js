...
(function() {
  var addExtraInputForCheckbox, baseValue, corruption, crime, danger, economy, getCityCatigory, gov_catigory, law, lore, magicItemCatigory, majorItems, mediumItems, minorItems, numberWithCommas, ordinal_suffix_of, purchaseLimit, society, spellcasting, updateDisadvantagesNames, updateLabelWithPlus, updateMagicItems, updateQualitiesNames, updateValues, updateValuesFromDisadvantages, updateValuesFromGovernment, updateValuesFromPopulation, updateValuesFromQualities;
  ...
  this.printerFriendly = function(element) {
    $('div.total_input_container').toggle();
    $('body').addClass('background_class');
    $('.remove_background').toggle();
    if ($(element).text() === "Printer Friendly") {
      return $(element).text("Show Input");
    } else {
      return $(element).text("Printer Friendly");
    }
  };

  this.hideBackground = function(element) {
    return $('body').toggleClass('background_class');
  };

  this.updateSettlement = function(element) {
    updateValues();
    ...
    if ($('#population_details_input').val()) {
      return $("label[for='dynamic_population_details_label']").text("(" + $('#population_details_input').val() + ")");
    } else {
      return $("label[for='dynamic_population_details_label']").text("");
    }
  };

  numberWithCommas = (function(_this) {
    return function(x) {
  ...
  updateLabelWithPlus = function(text, val) {
    if (val >= 0) {
      return $("label[for= " + text + " ]").text("+" + val);
    } else {
      return $("label[for= " + text + " ]").text(val);
    }
  };
  ...
  updateValues = function() {
    ...
    return updateMagicItems();
  };

  getCityCatigory = function() {
    var cat, pop;
    pop = $('#population_input').val();
    if (pop <= 20) {
      return cat = 1;
  ...
  updateValuesFromPopulation = function() {
    var cat, val;
    cat = getCityCatigory();
    ...
    if (cat <= 1) {
      ...
      baseValue = 200;
      purchaseLimit = 1000;
      return spellcasting = 2;
    } else if (cat === 3) {
      danger = -0;
      baseValue = 500;
      purchaseLimit = 2500;
      return spellcasting = 3;
    } else if (cat === 4) {
      danger = 0;
      baseValue = 1000;
      purchaseLimit = 5000;
      return spellcasting = 4;
    } else if (cat === 5) {
      danger = 5;
      baseValue = 2000;
      purchaseLimit = 10000;
      return spellcasting = 5;
    } else if (cat === 6) {
      danger = 5;
      baseValue = 4000;
      purchaseLimit = 25000;
      return spellcasting = 6;
    } else if (cat === 7) {
      danger = 10;
      baseValue = 8000;
      purchaseLimit = 50000;
      return spellcasting = 7;
    } else {
      danger = 10;
      baseValue = 16000;
      purchaseLimit = 100000;
      return spellcasting = 8;
    }
  };
  ...
  updateMagicItems = function() {
    if (magicItemCatigory <= 0) {
      ...
      mediumItems = "-";
      return majorItems = "-";
    } else if (magicItemCatigory === 1) {
      minorItems = "1d4";
      mediumItems = "-";
      return majorItems = "-";
    } else if (magicItemCatigory === 2) {
      minorItems = "1d6";
      mediumItems = "-";
      return majorItems = "-";
    } else if (magicItemCatigory === 3) {
      minorItems = "2d4";
      mediumItems = "1d4";
      return majorItems = "-";
    } else if (magicItemCatigory === 4) {
      minorItems = "3d4";
      mediumItems = "1d6";
      return majorItems = "-";
    } else if (magicItemCatigory === 5) {
      minorItems = "3d4";
      mediumItems = "2d4";
      return majorItems = "1d4";
    } else if (magicItemCatigory === 6) {
      minorItems = "4d4";
      mediumItems = "3d4";
      return majorItems = "1d6";
    } else if (magicItemCatigory === 7) {
      minorItems = "4d4";
      mediumItems = "3d4";
      return majorItems = "2d4";
    } else {
      minorItems = "nearly all";
      mediumItems = "4d4";
      return majorItems = "3d4";
    }
  };

  updateValuesFromGovernment = function() {
    var gov;
    ...
    if (gov === "Council") {
      ...
      society = society - 2;
      return spellcasting = spellcasting + 1;
    } else if (gov === "Overlord") {
      corruption = corruption + 2;
      law = law + 2;
      crime = crime - 2;
      return society = society - 2;
    } else if (gov === "Secret Syndicate") {
      corruption = corruption + 2;
      economy = economy + 2;
      crime = crime + 2;
      return law = law - 6;
  ...
  updateValuesFromDisadvantages = function() {
    var curse;
    ...
    if ($('#Cursed').is(':checked')) {
      ...
      if (curse === "Corruption") {
        ...
        crime = crime - 4;
      } else if (curse === "Economy") {
        economy = economy - 4;
      } else if (curse === "Law") {
        law = law - 4;
      } else if (curse === "Lore") {
        lore = lore - 4;
      } else if (curse === "Society") {
        society = society - 4;
      }
    }
    ...
    return updateDisadvantagesNames();
  };

  updateDisadvantagesNames = function() {
    var name;
    if ($('.disadvantages_checkbox:checked').length > 0) {
      name = $('.disadvantages_checkbox:checked').first().attr("name").replace(/_/g, " ");
      $('.disadvantages_checkbox:checked').slice(1).each((function(_this) {
        return function(index, box) {
          return name = name + ", " + $(box).attr("name").replace(/_/g, " ");
        };
      })(this));
      return $("label[for='dynamic_disadvantage_label']").text(name);
    }
  };

  updateQualitiesNames = function() {
    var name;
    if ($('.qualities:checked').length > 0) {
      ...
      $('.qualities:checked').slice(1).each((function(_this) {
        return function(index, box) {
          return name = name + ", " + $(box).attr("name").replace(/_/g, " ") + addExtraInputForCheckbox(box);
        };
      })(this));
      return $("label[for='dynamic_qualities_label']").text(name);
    } else {
      return $("label[for='dynamic_qualities_label']").text("");
    }
  };

  addExtraInputForCheckbox = function(box) {
    var input_name, result;
    input_name = "input#" + $(box).attr("name") + "_input";
    result = "";
    if ($(input_name).length && $(input_name).val().length > 0) {
      return result = " (" + $(input_name).val() + ")";
    } else {
      return result;
    }
  };

  updateValuesFromQualities = function() {
